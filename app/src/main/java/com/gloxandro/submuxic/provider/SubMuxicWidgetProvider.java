 ...
 */
package com.gloxandro.submuxic.provider;
...
import com.gloxandro.submuxic.service.DownloadServiceLifecycleSupport;
 ...
 * @author Sindre Mehus
 */
public class SubMuxicWidgetProvider extends AppWidgetProvider {
    private static final String TAG = SubMuxicWidgetProvider.class.getSimpleName();
	private static SubMuxicWidget4x1 instance4x1;
	private static SubMuxicWidget4x2 instance4x2;
	private static SubMuxicWidget4x3 instance4x3;
	private static SubMuxicWidget4x4 instance4x4;

	public static synchronized void notifyInstances(Context context, DownloadService service, boolean playing) {
		if(instance4x1 == null) {
			instance4x1 = new SubMuxicWidget4x1();
		}
		if(instance4x2 == null) {
			instance4x2 = new SubMuxicWidget4x2();
		}
		if(instance4x3 == null) {
			instance4x3 = new SubMuxicWidget4x3();
		}
		if(instance4x4 == null) {
			instance4x4 = new SubMuxicWidget4x4();
		}
     ...
     *
     * @param playerActive @param playerActive True if player is active in background.  Launch {@link com.gloxandro.submuxic.activity.SubsonicFragmentActivity}.
     */
    private void linkButtons(Context context, RemoteViews views, boolean playerActive) {
        ...
        intent = new Intent("SubMuxic.PLAY_PAUSE");
        ...
        intent = new Intent("SubMuxic.NEXT");  // Use a unique action name to ensure a different PendingIntent to be created.
        intent.setComponent(new ComponentName(context, DownloadService.class));
		intent.setAction(DownloadService.CMD_NEXT);
        pendingIntent = PendingIntent.getService(context, 0, intent, 0);
        views.setOnClickPendingIntent(R.id.control_next, pendingIntent);
        
        intent = new Intent("SubMuxic.PREVIOUS");  // Use a unique action name to ensure a different PendingIntent to be created.
        intent.setComponent(new ComponentName(context, DownloadService.class));
