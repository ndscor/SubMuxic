 ...
 * @author Sindre Mehus
 */
public class SubMuxicSearchProvider extends ContentProvider {
	private static final String TAG = SubMuxicSearchProvider.class.getSimpleName();

	private static final String RESOURCE_PREFIX = "android.resource://com.gloxandro.submuxic/";
