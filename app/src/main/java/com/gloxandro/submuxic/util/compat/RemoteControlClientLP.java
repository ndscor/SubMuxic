...
import com.gloxandro.submuxic.util.SilentServiceTask;
...
public class RemoteControlClientLP extends RemoteControlClientBase {
	...
	private static final String CUSTOM_ACTION_THUMBS_DOWN = "com.gloxandro.submuxic.THUMBS_DOWN";
	private static final String CUSTOM_ACTION_STAR = "com.gloxandro.submuxic.STAR";
	...
	public void register(Context context, ComponentName mediaButtonReceiverComponent) {
		...
		mediaSession = new MediaSessionCompat(downloadService, "SubMuxic MediaSession");
	...
	protected void addCustomActions(Entry currentSong, PlaybackStateCompat.Builder builder) {
		...
		PlaybackStateCompat.CustomAction star = new PlaybackStateCompat.CustomAction.Builder(CUSTOM_ACTION_STAR,
					...
					currentSong.isStarred() ? R.drawable.ic_baseline_star_24 : R.drawable.ic_twotone_star_border_24_white)
				.setExtras(showOnWearExtras).build();
