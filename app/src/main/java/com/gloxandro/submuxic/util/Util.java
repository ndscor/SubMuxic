...
public final class Util extends AppCompatActivity {
    ...
    public static final String EVENT_META_CHANGED = "com.gloxandro.submuxic.EVENT_META_CHANGED";
    public static final String EVENT_PLAYSTATE_CHANGED = "com.gloxandro.submuxic.EVENT_PLAYSTATE_CHANGED";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(null == savedInstanceState) {
			getFragmentManager().beginTransaction()
					.replace(android.R.id.content, new com.gloxandro.submuxic.colors.ColorsSettingsFragment())
					.commit();
		}
	}
	...
	public void changeActionBarColor(int newColor) {
		...
		int color = newColor != 0 ? newColor : Util.getPrimaryColor(this);
	...
	private static void addTrackInfo(Context context, MusicDirectory.Entry song, Intent intent) {
		if (song != null) {
			...
			intent.putExtra("coverart", albumArtFile.getAbsolutePath());
			intent.putExtra("package","com.gloxandro.submuxic");
		} else {
