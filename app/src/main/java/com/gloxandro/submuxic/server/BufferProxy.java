...
public class BufferProxy extends com.gloxandro.submuxic.server.FileProxy {
	...
	protected com.gloxandro.submuxic.server.BufferFile progress;

	public BufferProxy(Context context) {
		super(context);
	}

	protected ServerProxy.ProxyTask getTask(Socket client) {
		return new BufferFileTask(client);
	}

	public void setBufferFile(com.gloxandro.submuxic.server.BufferFile progress) {
