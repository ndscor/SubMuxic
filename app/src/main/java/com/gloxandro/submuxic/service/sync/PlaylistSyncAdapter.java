...
package com.gloxandro.submuxic.service.sync;
...
import com.gloxandro.submuxic.service.parser.SubsonicRESTException;
...
public class PlaylistSyncAdapter extends SubsonicSyncAdapter {
	...
	public void onExecuteSync(Context context, int instance) throws NetworkNotValidException {
		...
		ArrayList<SyncUtil.SyncSet> playlistList = SyncUtil.getSyncedPlaylists(context, instance);
		List<String> updated = new ArrayList<String>();
		String updatedId = null;
		boolean removed = false;
		for(int i = 0; i < playlistList.size(); i++) {
			SyncUtil.SyncSet cachedPlaylist = playlistList.get(i);
